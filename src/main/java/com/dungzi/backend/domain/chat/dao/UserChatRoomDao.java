...
public interface UserChatRoomDao extends JpaRepository<UserChatRoom, UUID> {
    ...
    List<UserChatRoom> findByUserAndChatRoomType(User user, ChatRoomType chatRoomType);
    Optional<UserChatRoom> findByChatRoomAndChatRoomType(ChatRoom chatRoom, ChatRoomType chatRoomType);
}